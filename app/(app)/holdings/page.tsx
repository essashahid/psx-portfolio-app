...
import { Briefcase, ChevronDown, Download, RefreshCw, Sparkles, Upload } from "lucide-react";
...
export default async function HoldingsPage() {
  ...
  const [summary, dailyPerformance] = await Promise.all([
