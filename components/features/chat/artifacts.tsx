...
import { INK, GlassTooltip, FadeDefs, CURSOR, useChartMotion, SERIES_COLORS } from "@/components/shared/chart-kit";
import { sectorColor, withAlpha } from "@/lib/shared/sector-colors";
...
const VegaLiteChart = dynamic(() => import("@/components/features/chat/vega-lite-chart"), {
  ssr: false,
  loading: () => (
