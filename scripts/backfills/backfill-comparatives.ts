 ...
 *
 *   npx tsx scripts/backfills/backfill-comparatives.ts --limit 5 --dry
 *   npx tsx scripts/backfills/backfill-comparatives.ts --limit 40
 *   npx tsx scripts/backfills/backfill-comparatives.ts --ticker KOHC
 */
