...
//   npx tsx scripts/backfills/backfill-index-history.ts
// Persist:
//   npx tsx scripts/backfills/backfill-index-history.ts --write
// Extra symbols:
//   npx tsx scripts/backfills/backfill-index-history.ts --symbols KSE100,KMI30 --write
