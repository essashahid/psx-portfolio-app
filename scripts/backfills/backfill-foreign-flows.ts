...
//
//   npx tsx scripts/backfills/backfill-foreign-flows.ts --from 2021-07-23        # dry run
//   npx tsx scripts/backfills/backfill-foreign-flows.ts --from 2021-07-23 --write
//   npx tsx scripts/backfills/backfill-foreign-flows.ts --from 2025-01-01 --write --limit 50
