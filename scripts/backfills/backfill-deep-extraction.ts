 ...
 *
 *   npx tsx scripts/backfills/backfill-deep-extraction.ts [--limit N] [--concurrency N]
 *   npx tsx scripts/backfills/backfill-deep-extraction.ts --tickers AAA,BBB
 *   npx tsx scripts/backfills/backfill-deep-extraction.ts --from-file data/queue.txt
 *
