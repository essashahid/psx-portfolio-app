 ...
 * data/generated/agent-reconcile-report.json.
 *
 ...
 *
 *   npx tsx scripts/maintenance/apply-bank-agent-corrections.ts --dry
 *   npx tsx scripts/maintenance/apply-bank-agent-corrections.ts
 */
