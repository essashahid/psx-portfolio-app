 ...
 *
 *   npx tsx scripts/maintenance/fix-divergent-universe.ts --dry     # list targets
 *   npx tsx scripts/maintenance/fix-divergent-universe.ts           # run
 */
...
async function main() {
  ...
  const CKPT = "data/queues/remediation-progress.json";
