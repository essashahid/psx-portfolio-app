 ...
 *
 *   npx tsx scripts/maintenance/promote-auto-verified.ts --dry
 *   npx tsx scripts/maintenance/promote-auto-verified.ts
 */
...
const EPS_TOL = 0.02;
const PB_TOL = 0.15;
const REGISTRY = "data/reference/verified-tickers.json";
