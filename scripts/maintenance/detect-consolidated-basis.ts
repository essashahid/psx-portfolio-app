 ...
 *
 *   npx tsx scripts/maintenance/detect-consolidated-basis.ts
 */
...
async function main(){
  ...
  const store = JSON.parse(readFileSync('data/reference/sarmaaya-snapshots.json','utf8')).snapshots as Record<string,{eps?:number}>;
