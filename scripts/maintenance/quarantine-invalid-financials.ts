 ...
 *
 *   npx tsx scripts/maintenance/quarantine-invalid-financials.ts            # dry run (default)
 *   npx tsx scripts/maintenance/quarantine-invalid-financials.ts --apply    # write changes
 */
