 ...
 *
 *   npx tsx scripts/audits/generate-unverified-list.ts
 */
...
async function main(){
  ...
  writeFileSync('data/generated/unverified-companies.md',md);

  writeFileSync('data/generated/unverified-companies.csv',
  ...
  console.log(`\nwritten: data/generated/unverified-companies.md and .csv`);
  console.log(`\nTop 30:`);
