 ...
 *
 *   npx tsx scripts/audits/ttm-integrity-audit.ts             # summary + top offenders
 *   npx tsx scripts/audits/ttm-integrity-audit.ts --all       # every affected ticker
 *   npx tsx scripts/audits/ttm-integrity-audit.ts --ticker X  # explain one company
 */
