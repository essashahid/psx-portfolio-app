...
//
//   npx tsx scripts/evaluations/eval-outlook-forecast.ts            # print report
//   npx tsx scripts/evaluations/eval-outlook-forecast.ts --write    # also write the artifacts
...
async function main() {
  ...
  if (write) {
    ...
    writeFileSync(resolve(process.cwd(), "data/reference/outlook-phase3-evaluation.json"), JSON.stringify(evaluation, null, 2));
    writeFileSync(resolve(process.cwd(), "data/reference/outlook-experimental.json"), JSON.stringify(outlook, null, 2));
    console.log("\nWrote data/reference/outlook-phase3-evaluation.json and data/reference/outlook-experimental.json");
  } else {
