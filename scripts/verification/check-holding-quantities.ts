// Ad-hoc diagnostic: prints per-ticker holding quantities.
//
// KNOWN BROKEN (pre-dates the repository reorganisation): the dynamic import
// below destructures `fetchEventsForUser`, which is not exported by
// @/lib/engine/allocation/data. Repair it before running. From the repo root:
//   npx tsx scripts/verification/check-holding-quantities.ts
