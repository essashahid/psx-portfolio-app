 ...
 *
 *   npx tsx scripts/data/build-filings-inventory.ts                        # full universe
 *   npx tsx scripts/data/build-filings-inventory.ts --sector "Commercial Banks"
 *   npx tsx scripts/data/build-filings-inventory.ts --tickers BAFL,JSBL,BAHL
 *   npx tsx scripts/data/build-filings-inventory.ts --limit 20              # sample
 *   npx tsx scripts/data/build-filings-inventory.ts --refresh NATF,PTC
 *
...
const MANIFEST = "data/reference/filings-inventory.json";
const CONCURRENCY = 8;
