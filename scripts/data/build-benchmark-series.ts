...
//   npx tsx scripts/data/build-benchmark-series.ts ./data/private/akd-account-statement-COAF5632.PDF
// Persist for a user:
//   npx tsx scripts/data/build-benchmark-series.ts ./data/private/akd-account-statement-COAF5632.PDF --write --email=you@example.com
