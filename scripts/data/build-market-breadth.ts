...
//
// Run after scripts/backfills/backfill-universe-eod.ts has deepened the universe. Breadth
// is derived, not captured, so this is safe to re-run at any time: it recomputes
// every day from prices and upserts the result.
//
//   npx tsx scripts/data/build-market-breadth.ts              # dry run, reports coverage
//   npx tsx scripts/data/build-market-breadth.ts --write
//   npx tsx scripts/data/build-market-breadth.ts --write --from 2024-01-01
