/**
 * Import the scraped Sarmaaya snapshot directory into data/reference/sarmaaya-snapshots.json.
 *
 * Source: data/external/sarmaya/stocks/{TICKER}.json, one file per company, each holding the
 ...
 *
 *   npx tsx scripts/data/import-sarmaaya-snapshots.ts
 */
...
const DIR = "data/external/sarmaya/stocks";
const OUT = "data/reference/sarmaaya-snapshots.json";
