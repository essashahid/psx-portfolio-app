...
/**
 * The market refresh job body. Lives in lib so /api/cron/market and
 * /api/cron/market/macro can both run it while each records its own job run.
 */
export async function marketJobHandler(request: Request) {
