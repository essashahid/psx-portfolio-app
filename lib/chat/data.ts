...
const RATIO_ORDER = [
  ...
  "Interest coverage", "Net interest margin", "Cost-to-income", "Non-markup income ratio",
  "Advances-to-deposits (ADR)", "NPL ratio",
  "Receivables / revenue", "Receivables / share", "Receivables % of market cap",
